...
US_EQUITY_RECORDS: tuple[TickerRecord, ...] = (
    ...
    TickerRecord(
        ...
        exchange="NYSE",
        currency="USD",
        aliases=("3m", "3m company", "明尼苏达矿务及制造", "明尼苏达矿业制造"),
        people=("bill brown",),
    ),
    TickerRecord(
        ticker="ORCL",
        ...
        exchange="NYSE",
        currency="USD",
        aliases=("oracle", "oracle corporation", "甲骨文", "甲骨文公司"),
        people=("larry ellison", "safra catz", "拉里埃里森"),
    ),
    TickerRecord(
        ticker="BRK.B",
    ...
    TickerRecord(
        ...
        exchange="NYSE",
        currency="USD",
        aliases=("eli lilly", "lilly", "礼来", "礼来公司"),
        people=("david ricks", "戴维里克斯"),
    ),
    TickerRecord(
        ticker="UNH",
        ...
        exchange="NYSE",
        currency="USD",
        aliases=("unitedhealth", "unitedhealth group", "联合健康", "联合健康集团"),
        people=("andrew witty", "安德鲁维蒂"),
    ),
    TickerRecord(
        ticker="JNJ",
        ...
        exchange="NYSE",
        currency="USD",
        aliases=("johnson and johnson", "johnson & johnson", "强生"),
        people=("joaquin duato", "华金杜阿托"),
    ),
    TickerRecord(
        ticker="ABBV",
